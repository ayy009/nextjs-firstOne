            ...
            <ul>
              {options.map((option: string, index: number) => (
                <li
                  ...
                  className={`flex w-full cursor-pointer items-center gap-2 rounded-sm px-2.5 py-1.5 text-left font-medium hover:text-dark dark:hover:text-white ${selectedOption === option ? "selected" : ""}`}
                >
                  {option}
                </li>
              ))}
